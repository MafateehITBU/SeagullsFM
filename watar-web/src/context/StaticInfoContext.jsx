 ...
 * We pick the row where channelId.name matches this value.
 * Set VITE_STATICINFO_CHANNEL in .env to match your Channel name in the CMS.
 */
    ...
    const fetchStaticInfo = async () => {
      try {
        ...
        const match = Array.isArray(list)
          ...
          : null
        setStaticInfo(mapStaticInfoFromApi(match))
      } catch (err) {
