...
import AddEventModal from "./modals/Event/AddEventModal.jsx";
import UpdateEventModal from "./modals/Event/UpdateEventModal.jsx";
...
const EventLayer = () => {
  ...
  const {
    ...
    state,
    setGlobalFilter,
  } = useTable({ columns, data: paginatedEvents }, useGlobalFilter, useSortBy);

  const noResultsAfterSearch =
    !loading && allEvents.length > 0 && rows.length === 0;
  ...
  return (
    <div className="card basic-data-table" style={{ minHeight: "65vh" }}>
      ...
      <div className="card-header d-flex flex-column flex-md-row justify-content-between align-items-center gap-3">
        <h5 className="card-title mb-0">Events & Partnerships</h5>
