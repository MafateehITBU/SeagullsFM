...
export default function ProgramDetailScreen() {
  ...
  const programImageUrl = program?.image?.url || program?.programDetailsImage?.url;
  const daysStr =
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.body}>
          ...
          {program.description ? (
            <RichTextContent html={program.description} style={styles.description} />
          ) : null}
              ...
              <View key={interview._id} style={styles.interviewCard}>
                <View style={styles.interviewCardContent}>
                  ...
                  {interview.description ? (
                    <RichTextContent
                      html={interview.description}
                      style={styles.interviewDescription}
                      numberOfLines={3}
                    />
                  ) : null}
