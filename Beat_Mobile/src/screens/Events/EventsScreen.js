      ...
      try {
        ...
        if (json.success && Array.isArray(json.data)) {
          const moodFm = json.data.filter(
            (item) => item.channelId && item.channelId.name === 'BeatFM'
          );
          setEvents(moodFm);
        } else {
          setEvents([]);
        ...
        <View style={[styles.heroSectionWrap, { height: HERO_HEIGHT }]}>
          ...
          >
            ...
            <Text style={styles.heroSubtitle}>
              Live music, DJ nights, and unforgettable experiences by Beat FM.
            </Text>
        ...
        <View style={styles.gridSection}>
          {loading ? (
            ...
            <View style={styles.emptyContainer}>
              ...
              <Text style={styles.emptyText}>Check back later for Beat FM events.</Text>
            </View>
          ) : (
