...
const PrivacyPolicy = () => {
  return (
    <>
      ...
      <section className="who-we-are-section flex-column-start" style={{ height: 'auto', minHeight: 'auto', paddingBottom: '3rem' }}>
        <p className="who-we-are-description" style={{ marginBottom: '2rem' }}>
          This Privacy Policy applies to <strong>Mood FM</strong> (“the App”), the website at mood.fm, and related services operated by <strong>{DEVELOPER_NAME}</strong>. By using Mood FM, you agree to the collection and use of information as described in this policy.
        </p>
        ...
        <p className="who-we-are-description" style={{ marginBottom: '1rem' }}>
          We use the information to provide, maintain, and improve Mood FM; to communicate with you about the service; to personalise your experience where applicable; and to comply with legal obligations. We do not sell your personal information to third parties.
        </p>
        ...
        <p className="who-we-are-description" style={{ marginBottom: '1rem' }}>
          Our website may use cookies and similar technologies to remember your preferences and to understand how the site is used. You can control cookie settings through your browser.
        </p>

        <h2 className="who-we-are-title" style={{ fontSize: '1.5rem', marginTop: '1.5rem', marginBottom: '0.75rem' }}>Data Storage and Security</h2>
        <p className="who-we-are-description" style={{ marginBottom: '1rem' }}>
          We store your data securely and retain it only for as long as necessary to provide the service and fulfil the purposes described in this policy. We take reasonable measures to protect your information from unauthorised access or disclosure.
        </p>

        <h2 className="who-we-are-title" style={{ fontSize: '1.5rem', marginTop: '1.5rem', marginBottom: '0.75rem' }}>Third Parties</h2>
        <p className="who-we-are-description" style={{ marginBottom: '1rem' }}>
          We may use third-party services (such as hosting, analytics, or authentication) that process data on our behalf. These providers are bound by agreements to protect your data and use it only for the purposes we specify.
        </p>
        ...
        <p className="who-we-are-description" style={{ marginBottom: '1rem' }}>
          Mood FM is not directed at children under 13. We do not knowingly collect personal information from children under 13. If you believe we have collected such information, please contact us so we can delete it.
        </p>

        <h2 className="who-we-are-title" style={{ fontSize: '1.5rem', marginTop: '1.5rem', marginBottom: '0.75rem' }}>Changes to This Policy</h2>
        <p className="who-we-are-description" style={{ marginBottom: '1rem' }}>
          We may update this Privacy Policy from time to time. We will post the updated policy on this page and, where appropriate, notify you through the App or by email. The “Last updated” date below indicates when the policy was last revised.
        </p>
        ...
        <p className="who-we-are-description" style={{ marginBottom: '0.5rem' }}>
          If you have questions about this Privacy Policy or your personal data, please contact us at the contact details provided on the Mood FM website (mood.fm) or within the Mood FM app.
        </p>
